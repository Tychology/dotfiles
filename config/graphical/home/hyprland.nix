...
in
  with lib; {
    ...
    wayland.windowManager.hyprland = {
      ...
      # ];
      settings.cursor.no_hardware_cursors = true;
      extraConfig = let
        modifier = "SUPER";
      in
        concatStrings [
          ''
            ...
            ${variables.extraMonitorSettings}
            general {
              gaps_in = 6
              gaps_out = 8
              border_size = 2
              ...
              col.active_border = rgb(${stylixBase16.base08}) rgb(${stylixBase16.base0C}) 45deg
              col.inactive_border = rgb(${stylixBase16.base01})
            }
            input {
              kb_layout = de
            ...
            bind = ${modifier},M,exec,thunderbird
            ...
            bind = ALT, SPACE, exec, QT_QPA_PLATFORM=xcb albert toggle
