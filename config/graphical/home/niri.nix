  ...
  programs.niri = {
    ...
    config = ''
      ...
      layout {
          ...
          border {
              width 2
              active-gradient from="${stylixBase16.base08}" to="${stylixBase16.base0C}" angle=45 in="oklab"
              inactive-color "${stylixBase16.base01}"
          }
          focus-ring {
              off
          }
      ...
      spawn-at-startup "systemd-run" "--user" "--scope" "waybar"
      spawn-at-startup "wlsunset" "-l 52.52" "-L 13.40" "-t 4000"
      ...
      binds {
          ...
          Mod+adiaeresis { show-hotkey-overlay; }
          ...
          Mod+odiaeresis repeat=false { toggle-overview; }
    ...
    #       width = 2;
    #       active.gradient = {
    #         from = stylixBase16.base08;
    #         to = stylixBase16.base0C;
    #         angle = 45;
    #         in' = "oklab";
    #       };
    #       inactive.color = stylixBase16.base01;
    ...
    #     {sh = "sleep 1.5 && swww img /home/${username}/Pictures/Wallpapers/${wallpaper}";}
    #   ];
    #   binds = {
    #     "Print".action.spawn = "screenshooting";
    #     "Mod+Z".action.spawn = "zed";
    #     "Mod+W".action.spawn = variables.browser;
